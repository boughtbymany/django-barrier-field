# Generated by Django 2.1.2 on 2018-10-22 05:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        swapper.dependency('barrier_field', 'UserData')
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'swappable': swapper.swappable_setting('barrier_field', 'User'),
                'verbose_name': 'user',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=swapper.get_model_name('barrier_field', 'UserData')),
        ),
        migrations.AddField(
            model_name='user',
